    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4><b>DATA TARUNA TINGKAT III YANG MELANGGAR</b></h4>
...
<div class="row">
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <td style="text-align: center">
                                ...
                                @include('pelanggaran.tingkat3.modal-edit')
                                <form method="POST" action="{{ route('Tingkat3-pelanggaran.destroy', $item->id) }}" class="d-inline">
                                    @csrf @method('DELETE')
    ...
    @include('pelanggaran.tingkat3.modal')
@endsection