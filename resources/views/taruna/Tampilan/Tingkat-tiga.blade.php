        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <form method="POST" action="{{ route('deleteAll') }}" class="d-inline">
                        @csrf @method('DELETE')
                        <button class="btn btn-danger delete-btn" type="button">
                            <i class="fa-solid fa-trash"></i> Delete All
                        </button>
                    </form>
                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target=".bd-example-modal-sm" style="margin-right: 45em">Edit Tingkat All</button>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-responsive-sm">
                            ...
                            <tbody>
                              ...
                              @include('taruna.crud.modal-edit-tingkat3')
