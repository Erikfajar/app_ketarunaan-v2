                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>
                                    ...
                                    {{-- <div class="form-check custom-checkbox checkbox-success check-lg me-3">
                                        <input name="selectedIds[]" type="checkbox" value="{{ $item->id }}" class="form-check-input checkBoxClass" id="selectedIds[]" required="">
                              ...
                              @include('taruna.crud.modal-edit-tingkat2')
