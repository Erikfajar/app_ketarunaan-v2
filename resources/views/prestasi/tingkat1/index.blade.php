    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4><b>DATA TARUNA TINGKAT I YANG BERPRESTASI</b></h4>
...
<div class="row">
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <td style="text-align: center">
                                ...
                                @include('prestasi.tingkat1.modal-edit')
                                <form method="POST" action="{{ route('Tingkat1-prestasi.destroy', $item->id) }}" class="d-inline">
                                    @csrf @method('DELETE')
    ...
    @include('prestasi.tingkat1.modal')
@endsection