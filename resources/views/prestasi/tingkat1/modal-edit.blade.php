    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('Tingkat1-prestasi.update',$item->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                ...
                <div class="form-group col-md12">
                    ...
                    <input type="text" name="prestasi" value="{{ $item->prestasi }}" class="form-control" placeholder="Prestasi">
                </div>
                <div class="form-group col-md12">
